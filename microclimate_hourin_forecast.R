...
longlat<-geocode(loc)[1,3:4]
longlat<-c(136.811,-33.1946)
prevdir<-getwd()
setwd('Y:')
...
julnum<-2 # number of time intervals to generate predictions for over a year (must be 12 <= x <=365)
...
microinput<-c(julnum,RUF,ERR,Usrhyt,Numtyps,Numint,Z01,Z02,ZH1,ZH2,idayst,ida,HEMIS,ALAT,AMINUT,ALONG,ALMINT,ALREF,slope,azmuth,ALTT,CMH2O,microdaily,tannul,EC,VIEWF,snowtemp,snowdens,snowmelt,undercatch,fieldcap,wilting,rainmult,runshade,grasshade,starthour)
