...
c      double precision, allocatable, dimension(:,:) :: NODES2
      ...
      INTEGER NOUT,NPOS,NUMINT,NUMRUN,NUMTYPS,NUMDAY
...
c    adding in for NicheMapR
      ...
      INTEGER microdaily,numyear,NN,STARTHOUR
     ...
     &,shadsoil2,moists2,soilprop2,RAINhr2,nodes2,
     &rain2,tannulrun2,TAIRhr2,RHhr2,WNhr2,CLDhr2,IRhr2,SOLRhr2
     ...
     & CLDhr2(24*7300),IRhr2(24*7300),SOLRhr2(24*7300),RAINhr2(24*7300)
...
39    continue
      ...
      read(1,*)LABEL
      do 40 i=1,10
      read(1,*)label,(moists2(i,j),j=1,numday)
40    continue
      close(1)
...
c     &shadmet1,shadsoil1)
      ...
      call micr2014hr(microinput2,julday2,SLES2,DEP2,
     ...
     &rain2,tannulrun2,TAIRhr2,RHhr2,WNhr2,CLDhr2,IRhr2,
     &SOLRhr2,RAINhr2,metout2,soil2,shadmet2,shadsoil2)
